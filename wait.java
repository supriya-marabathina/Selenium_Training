...
public class wait {
	...
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li/div/div/p[contains(text(),'Delhi')])[1]")));
	...
	/*	//date locator
		...
		for(WebElement date:dates){
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(),'Popular')]/following-sibling::div//span[@title='Non Stop']/preceding::span[@class='customCheckbox']")));
